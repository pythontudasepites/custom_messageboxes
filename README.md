...
Az üzenetablakok szerkezete és kinézete hasonló. Az ablak felső részén a címsor, alul vízszintesen pedig az üzenetablak típusától függően egy vagy több nyomógomb látható. E kettő közötti terület bal felső részben  az üzenetfajtához illő ikongrafika, ettől jobbra az üzenetszövegeket megjelenítő terület.
...
A tájékoztató, figyelmeztető és hibajelző ablakokat létrehozó `showinfo()`, `showwarning()`, `showerror()` függvények  mindegyike egyetlen, OK feliratú gombot tartalmaz, minthogy ezeknél csak tudomásul kell venni az üzenetet.
...
Ezért, ha alkalmazásunkban jobban olvasható, színesebb megjelenésű üzenetablakokra van szükség, érdemes egy olyan saját modult készíteni, amely hasonló funkcionalitású függvényeket kínál, de olyan üzenetablakokat jelenít meg, amelyek mentesek az említett korlátoktól.
